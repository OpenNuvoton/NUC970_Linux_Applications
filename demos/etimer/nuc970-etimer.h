...
#define ETMR_IOC_PERIODIC            _IOW(ETMR_IOC_MAGIC, 4, unsigned int *) /* Start etimer in periodic mode */
#define ETMR_IOC_PERIODIC_FOR_WKUP	_IOW(ETMR_IOC_MAGIC, 5, unsigned int *)   /* Wake-up etimer in periodic mode */
